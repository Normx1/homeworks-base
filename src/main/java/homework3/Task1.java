...
public class Task1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Сумма эл. главной диагонали- " + summ);
        ...
        System.out.println("Произведение элементов гл. диагонали:" + "\n" + pr1);
        System.out.println("Произведение элементов втор. диагонали:" + "\n" + pr2);
        if (pr1 > pr2) {
